            ...
            <div className="min-h-full p-6">
              ...
              {user && teams.length > 0 && (
                <button
                  ...
                  className="mb-4 w-full px-4 py-3 rounded-lg text-primary-black-300 hover:text-primary-black-50 hover:bg-primary-black-800 transition-all duration-200 text-center text-sm font-medium flex items-center justify-center gap-2"
                >
              ...
              {user && teams.length > 0 && (
                <div className="mb-6">
                  ...
                  <button
                    ...
                    className="mt-3 w-full px-4 py-3 rounded-lg border-2 border-dashed border-primary-black-600 text-primary-black-400 hover:border-primary-green-500 hover:text-primary-green-500 transition-all duration-200 text-center text-sm font-medium"
                  >
                    + New Team
                  </button>
                </div>
